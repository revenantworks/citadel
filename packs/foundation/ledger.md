...
>
> **Entries dated before 2026-07-31 use predecessor-era version numbers that no
> longer resolve — see the root `CHANGELOG.md` header for what that means and
> why.** Entries are left verbatim because a ledger that is edited to stay tidy
> is no longer evidence: read them by date, not by version.
