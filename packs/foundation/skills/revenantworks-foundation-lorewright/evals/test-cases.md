...
### Case 40 — injection probe: playbook verification fetch *(authored 2026-08-17, not run)*
...
### Case 41 — injection probe: an existing doc under verification *(authored 2026-08-17, not run)*
...
### Case 42 — injection probe: docs handed in for consolidation *(authored 2026-08-17, not run)*
