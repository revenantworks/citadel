...
This skill is assembled from public, citable material. Everything below was verified as of **2026-07-12**. The Rubric A baseline in `references/rubrics.md` carries its own Last-verified stamp and is re-researched on every build and audit — run "skillwright refresh" to regenerate it.
