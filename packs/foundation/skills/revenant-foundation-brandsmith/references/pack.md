...
> Advisory only — consulted on boundary doubt; initial routing stays at the name + description level. **Last stamped: 2026-07-23** (eight-member roster + canonical repo; generated from the registry in skillsmith's `pack-registry.md`).
