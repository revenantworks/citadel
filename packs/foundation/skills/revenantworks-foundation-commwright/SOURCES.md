...
|---|---|
| Anthropic — Agent Skills best-practices + overview docs (platform.claude.com → agents-and-tools/agent-skills) | Body/reference split, description routing, progressive disclosure, eval-driven iteration. |
| Agent Skills open standard — https://agentskills.io | Frontmatter fields, naming and description limits. |
| Keep a Changelog — https://keepachangelog.com | GitHub release-notes profile buckets. |
