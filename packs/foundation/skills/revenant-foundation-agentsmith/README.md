...
**Standing first targets** *(owner’s note, as of 2026-07-13)*: the Research Agent and Entry Scan trading specs — this pack’s live agents, queued for audit mode.
...
The checklist encodes durable control doctrine, not volatile facts — no stamped baseline. When the pack's audit norms move (skillsmith refresh territory), audits inherit them through the pack.
