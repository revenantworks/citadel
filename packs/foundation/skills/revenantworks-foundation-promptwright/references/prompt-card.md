...
- **Brand-neutral by default:** the template ships a neutral dark theme and a neutral "Prompt Card" label — no brand identity is applied here. To brand a card (palette, wordmark), run `brandwright apply`; brandwright is the single home of brand application. Keep any exported card honest about what it is.
