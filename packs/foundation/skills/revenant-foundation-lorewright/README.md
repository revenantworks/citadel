...
|---|---|
| `lorewright` | Bare invocation — capability line, then asks what to decide or document |
| `lorewright verdict` | Forces verdict mode |
| `lorewright playbook` | Forces playbook mode |
